classdef OpenIGTLinkROSAdapter < handle
    ...
    methods
        function setIgtlConnection(this, igtl_server_ip, igtl_port)
            this.igtlConnection = igtlConnect(igtl_server_ip, igtl_port);
        end
        function obj = OpenIGTLinkROSAdapter(igtl_server_ip, igtl_port, ros_master_uri, topic_name)
            obj.topicName = topic_name;
            obj.setIgtlConnection(igtl_server_ip, igtl_port);
